...
KAUFLAND_REST_API_PATH="$PROJECT_ROOT/libs/kaufland-rest-api"
...
# Install kaufland-rest-api in editable mode
echo "Installing kaufland-rest-api..."
"$VENV_PIP" install -e "$KAUFLAND_REST_API_PATH"
